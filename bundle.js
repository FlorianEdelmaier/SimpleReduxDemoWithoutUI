...
/***/ function(module, exports, __webpack_require__) {
	...
	function todos() {
	    ...
	    switch (action.type) {
	        ...
	        case constants.TOGGLE_TODO:
	            return [].concat(_toConsumableArray(state.slice(0, action.index)), [todo(state[action.index], action)], _toConsumableArray(state.slice(action.index + 1)));
	        default:
	            return state;
	    }
	};
	...
	var reducer = (0, _redux.combineReducers)({ todos: todos, visibilityFilter: visibilityFilter });
	...
	(_console = console).log.apply(_console, _toConsumableArray(store.getState().todos));
